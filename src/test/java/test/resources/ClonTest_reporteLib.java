...
//	logger.init(curDir + "\\"+nombreCarpeta+"\\"+nombreClase+"\\ReporteResultados.html",true);
	...
	String pathEvidencia_pantallaInicial = curDir + "/"+ nombreCarpeta +"/"+ nombreClase + "/"+ "Evidencias" + "/1_Pantalla_Inicial.png";	
	...
	String pathEvidencia_AdminInterf = curDir + "/"+ nombreCarpeta +"/"+ nombreClase + "/"+ "Evidencias" + "\\2_Pantalla Admin_Interface.png";	
    ...
    String pathEvidencia_ultimaPantalla = curDir + "/"+ nombreCarpeta +"/"+ nombreClase + "/"+ "Evidencias" + "/3_Ultima_Pantalla.png";	
